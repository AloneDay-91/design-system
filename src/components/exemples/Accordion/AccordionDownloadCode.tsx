...
export function AccordionDownloadCode() {
  return (
    <DownloadCode
    ...
    return (
      <button
        ...
        className={twMerge(
          ...
          "bg-background py-4 px-0 text-left font-medium text-foreground text-lg",
...
const accordionState = reactive({
  ...
  onValueChange: (newValue: string[]) => {
    ...
    if (!props.value) {
      accordionState.value = newValue
    }
    emit('value-change', newValue)
  },
  openMultiple: props.openMultiple,
  disabled: props.disabled,
  orientation: props.orientation
})

provide('accordion', accordionState)
